...
public class CarsAssembleTest {
    ...
    @Test
    @Tag("task:1")
    @DisplayName("task:1 :The productionRatePerHour method returns the correct result when line's speed is 0")
    ...
    @Test
    @Tag("task:1")
    @DisplayName("task:1 :The productionRatePerHour method returns the correct result when line's speed is 1")
    ...
    @Test
    @Tag("task:1")
    @DisplayName("task:1 :The productionRatePerHour method returns the correct result when line's speed is 4")
    ...
    @Test
    @Tag("task:1")
    @DisplayName("task:1 :The productionRatePerHour method returns the correct result when line's speed is 7")
    ...
    @Test
    @Tag("task:1")
    @DisplayName("task:1 :The productionRatePerHour method returns the correct result when line's speed is 9")
    ...
    @Test
    @Tag("task:1")
    @DisplayName("task:1 :The productionRatePerHour method returns the correct result when line's speed is 10")
    ...
    @Test
    @Tag("task:2")
    @DisplayName("task:2 :The workingItemsPerMinute should be 0 when line's speed is 0")
    ...
    @Test
    @Tag("task:2")
    @DisplayName("task:2 :The workingItemsPerMinute should be 3 when line's speed is 1")
    ...
    @Test
    @Tag("task:2")
    @DisplayName("task:2 :The workingItemsPerMinute should be 16 when line's speed is 5")
    ...
    @Test
    @Tag("task:2")
    @DisplayName("task:2 :The workingItemsPerMinute should be 26 when line's speed is 8")
    ...
    @Test
    @Tag("task:2")
    @DisplayName("task:2 :The workingItemsPerMinute should be 26 when line's speed is 9")
    ...
    @Test
    @Tag("task:2")
    @DisplayName("task:2 The workingItemsPerMinute should be 28 when line's speed is 10")
