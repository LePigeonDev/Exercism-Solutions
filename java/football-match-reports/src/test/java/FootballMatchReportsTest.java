...
public class FootballMatchReportsTest {
    ...
    @Test
    @Tag("task:1")
    @DisplayName("task:1 :The onField method returns the correct description of player with shirt number 1")
    ...
    @Test
    @Tag("task:1")
    @DisplayName("task:1 :The onField method returns the correct description of player with shirt number 2")
    ...
    @Test
    @Tag("task:1")
    @DisplayName("task:1 :The onField method returns the correct description of player with shirt number 5")
    ...
    @Test
    @Tag("task:1")
    @DisplayName("task:1 :The onField method returns the correct description of players with shirt numbers 3 and 4")
    ...
    @Test
    @Tag("task:1")
    @DisplayName("task:1 :The onField method returns the correct description of players with shirt numbers 6, 7 and 8")
    ...
    @Test
    @Tag("task:1")
    @DisplayName("task:1 :The onField method returns the correct description of player with shirt number 9")
    ...
    @Test
    @Tag("task:1")
    @DisplayName("task:1 :The onField method returns the correct description of player with shirt number 10")
    ...
    @Test
    @Tag("task:1")
    @DisplayName("task:1 :The onField method returns the correct description of player with shirt number 11")
    ...
    @Test
    @Tag("task:2")
    @DisplayName("task:2 :The onField method returns 'invalid' for invalid shirt number")
    ...
    @Test
    @Tag("task:2")
    @DisplayName("task:2 :The onField method returns 'invalid' for negative shirt number")
