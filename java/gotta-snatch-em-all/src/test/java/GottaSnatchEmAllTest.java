...
class GottaSnatchEmAllTest {
    ...
    @Test
    @Tag("task:1")
    @DisplayName("task:1: newCollection returns an empty set when given an empty list")
    ...
    @Test
    @Tag("task:1")
    @DisplayName("task:1: newCollection returns a set with one card when given a list with one card")
    ...
    @Test
    @Tag("task:1")
    @DisplayName("task:1: newCollection returns a set with one card when given a list with one repeated card")
    ...
    @Test
    @Tag("task:1")
    @DisplayName("task:1: newCollection returns a set with two cards when given a list with two unique cards")
    ...
    @Test
    @Tag("task:2")
    @DisplayName("task:2: addCard returns true when the collection does not yet contain the new card")
    ...
    @Test
    @Tag("task:2")
    @DisplayName("task:2: addCard returns false when the collection already contains the new card")
    ...
    @Test
    @Tag("task:2")
    @DisplayName("task:2: addCard adds the card to the collection when it is a new card")
    ...
    @Test
    @Tag("task:2")
    @DisplayName("task:2: addCard doesn't add the card to the collection when it already contains the new card")
    ...
    @Test
    @Tag("task:3")
    @DisplayName("task:3: canTrade returns false when both collections are empty")
    ...
    @Test
    @Tag("task:3")
    @DisplayName("task:3: canTrade returns false when my collections is empty")
    ...
    @Test
    @Tag("task:3")
    @DisplayName("task:3: canTrade returns false when their collections is empty")
    ...
    @Test
    @Tag("task:3")
    @DisplayName("task:3: canTrade returns false when both collections have the same cards")
    ...
    @Test
    @Tag("task:3")
    @DisplayName("task:3: canTrade returns true when both collections have unique cards")
    ...
    @Test
    @Tag("task:3")
    @DisplayName("task:3: canTrade returns true when both collections have at least one card the other doesn't have")
    ...
    @Test
    @Tag("task:3")
    @DisplayName("task:3: canTrade returns false when my collection is a non-empty subset of their collection")
    ...
    @Test
    @Tag("task:3")
    @DisplayName("task:3: canTrade returns false when their collection is a non-empty subset of my collection")
    ...
    @Test
    @Tag("task:4")
    @DisplayName("task:4: commonCards returns an empty set when all cards are different")
    ...
    @Test
    @Tag("task:4")
    @DisplayName("task:4: commonCards returns a set with all cards when given a single collection")
    ...
    @Test
    @Tag("task:4")
    @DisplayName("task:4: commonCards returns a set with cards present in all given collections")
    ...
    @Test
    @Tag("task:5")
    @DisplayName("task:5: allCards returns a set with all cards when given a single collection")
    ...
    @Test
    @Tag("task:5")
    @DisplayName("task:5: allCards returns a set with all cards when given multiple collections")
