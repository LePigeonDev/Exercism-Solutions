...
public class JedliksToyCarTest {
    @Test
    @Tag("task:1")
    @DisplayName("task:1 :The static buy method returns a new remote controlled car instance")
    ...
    @Test
    @Tag("task:1")
    @DisplayName("task:1 :The static buy method returns each time a new remote controlled car instance")
    ...
    @Test
    @Tag("task:2")
    @DisplayName("task:2 :The distanceDisplay method shows 0 meters message on a new car")
    ...
    @Test
    @Tag("task:3")
    @DisplayName("task:3 :The batteryDisplay method shows full battery message on a new car")
    ...
    @Test
    @Tag("task:4")
    @DisplayName("task:4 :The distanceDisplay method shows the correct message after driving once")
    ...
    @Test
    @Tag("task:4")
    @DisplayName("task:4 :The distanceDisplay method shows the correct message after driving multiple times")
    ...
    @Test
    @Tag("task:5")
    @DisplayName("task:5 :The batteryDisplay method shows the correct message after driving once")
    ...
    @Test
    @Tag("task:5")
    @DisplayName("task:5 :The batteryDisplay method shows the correct battery percentage after driving multiple times")
    ...
    @Test
    @Tag("task:5")
    @DisplayName("task:5 :The batteryDisplay method shows battery empty after draining all battery")
    ...
    @Test
    @Tag("task:6")
    @DisplayName("task:6 :The distanceDisplay method shows the correct message after driving and draining all battery")
