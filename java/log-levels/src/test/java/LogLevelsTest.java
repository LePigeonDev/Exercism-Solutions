...
public class LogLevelsTest {
    @Test
    @Tag("task:1")
    @DisplayName("task:1 :The message method returns the log line's message of an error log")
    ...
    @Test
    @Tag("task:1")
    @DisplayName("task:1 :The message method returns the log line's message of a warning log")
    ...
    @Test
    @Tag("task:1")
    @DisplayName("task:1 :The message method returns the log line's message of an info log")
    ...
    @Test
    @Tag("task:1")
    @DisplayName("task:1 :The message method returns the log line's message after removing leading and trailing spaces")
    ...
    @Test
    @Tag("task:2")
    @DisplayName("task:2 :The logLevel method returns the log level of an error log line")
    ...
    @Test
    @Tag("task:2")
    @DisplayName("task:2 :The logLevel method returns the log level of a warning log line")
    ...
    @Test
    @Tag("task:2")
    @DisplayName("task:2 :The logLevel method returns the log level of an info log line")
    ...
    @Test
    @Tag("task:3")
    @DisplayName("task:3 :The reformat method correctly reformats an error log line")
    ...
    @Test
    @Tag("task:3")
    @DisplayName("task:3 :The reformat method correctly reformats a warning log line")
    ...
    @Test
    @Tag("task:3")
    @DisplayName("task:3 :The reformat method correctly reformats an info log line")
    ...
    @Test
    @Tag("task:3")
    @DisplayName("task:3 :The reformat method correctly reformats an error log line removing spaces")
