...
public class SalaryCalculatorTest {
    ...
    @Test
    @Tag("task:1")
    @DisplayName("task:1 :The salaryMultiplier method returns 1.0 when daysSkipped is below the threshold")
    ...
    @Test
    @Tag("task:1")
    @DisplayName("task:1 :The salaryMultiplier method returns 0.85 when daysSkipped is equal to the threshold")
    ...
    @Test
    @Tag("task:1")
    @DisplayName("task:1 :The bonusMultiplier method returns 0.85 when daysSkipped is above the threshold")
    ...
    @Test
    @Tag("task:2")
    @DisplayName("task:2 :The bonusMultiplier method returns 10 when productsSold is below the threshold")
    ...
    @Test
    @Tag("task:2")
    @DisplayName("task:2 :The bonusMultiplier method returns 13 when productsSold is equal to the threshold")
    ...
    @Test
    @Tag("task:2")
    @DisplayName("task:2 :The bonusMultiplier method returns 13 when productsSold is above the threshold")
    ...
    @Test
    @Tag("task:2")
    @DisplayName("task:2 :The bonusForProductsSold method returns the right result")
    ...
    @Test
    @Tag("task:3")
    @DisplayName("task:3 :The finalSalary method returns the regular salary without multiplier and bonus")
    ...
    @Test
    @Tag("task:3")
    @DisplayName("task:3 :The finalSalary method returns the correct result when daysSkipped above threshold")
    ...
    @Test
    @Tag("task:3")
    @DisplayName("task:3 :The finalSalary method returns the correct result when daysSkipped and productsSold below threshold")
    ...
    @Test
    @Tag("task:3")
    @DisplayName("task:3 :The finalSalary method returns the correct result capped at maximum salary")
